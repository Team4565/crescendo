...
@SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  ...
  private final DoubleSolenoid m_climbSolenoid = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, HatchConstants.kClimbSolenoidPorts[2], HatchConstants.kClimbSolenoidPorts[3]);
